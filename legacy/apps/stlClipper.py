...
def main():
    ...
    INPUT_FILE = "windAroundBuildings/Tools/output/wRaster/terrainKilbourn.stl"          # Path to input STL file
    OUTPUT_FILE = "windAroundBuildings/Tools/output/terrainKilbourn_clippedExtended.stl"       # Path to output STL file
    # Clipping bounds: [xmin, ymin, zmin, xmax, ymax, zmax]
    CLIP_BOUNDS = [-452.90, -402.33, 570, 550.99, 406.98, 704.98]
    # CLIP_BOUNDS = [-352.90, -302.33, 620, 350.99, 276.98, 704.98]
    # Output options
