...
def main():
    ...
    # TERRAIN_STL_FILE = "input/terrainKilbourn.stl"   # Path to your terrain STL file
    TERRAIN_STL_FILE = "/Users/omokayj/Library/CloudStorage/OneDrive-MarquetteUniversity/Research/Research - Fall 25/3dprint/terrain_Marquette_conservative_fixed_clipped.stl"
    ...
    #     'z_min': 570.338,    # np.float64(630.3375607466452)
    #     'z_max': 704.983     # np.float64(704.9825786398455)
    # }
    TERRAIN_BOUNDS = {
        'x_min': -500,   # np.float64(-352.89520972478203)
        'x_max': 500,    # np.float64(350.9880754571059)  
        'y_min': -500,   # np.float64(-302.33025516569614)
        'y_max': 500,    # np.float64(306.9790263324976)
        'z_min': 580,    # np.float64(630.3375607466452)
        'z_max': 720     # np.float64(704.9825786398455)
    }
    ...
    BASE_THICKNESS = 0.0           # How thick the base should be below terrain
    BASE_MARGIN = 0.0              # Extra margin around terrain bounds
    ...
    # BASE_EXTENTS = [-360, -305, 615, -120, 50, 670]
