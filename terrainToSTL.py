...
def add_base_and_sides(triangles, base_thickness=1.0):
    ...
    print("Adding base and side walls with 1m base thickness...")
    ...
    # Fixed base thickness of 1 meter
...
if __name__ == "__main__":
    ...
    output_file = "/Users/omokayj/vsCode.local/urbanWindFlow/Tools/output/terrainMarquette.stl"  
    ...
    result = dem_to_stl_with_offset(
        ...
        add_base=False,                 # Add base for solid geometry
